...
Or tidygraph. You can extract tidygraph's tbl_graph object and then use its verbs:
...
Or maybe even better, you can use tidygraph verbs directly on discourse_graph objects:
